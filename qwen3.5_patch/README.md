...
These patches were regenerated against the clean OpenVINO official release tag
`2026.3.1`:

```
759c5a6ab8c066af5f4bc5ebd04643706012a37d (tag: 2026.3.1)
```

Each patch and the documented patch chain were replayed on a clean
`2026.3.1` checkout with `git apply`.
